...
pub mod description {
    use leptos::prelude::*;
    use syre_desktop_ui_components::form::debounced::TextArea;
...
pub mod metadata {
    ...
    use super::super::types::InputDebounce;
    use leptos::{
        either::either,
    ...
    use syre_desktop_ui_components::form::{InputNumber, debounced};
...
pub mod bulk {
                                            ...
                                            view! {
                                                <li class=tag_class.clone()>
                                                    ...
                                                    >
                                                        ...
                                                        <Icon icon=ui_lib::icon::Remove attr:class="inline-block" />
                                                    </button>
                                                </li>
                                            }
                                        })
    ...
    pub mod metadata {
        ...
        use syre_desktop_ui_components::form::InputNumber;
        use syre_desktop_ui_lib as ui_lib;
