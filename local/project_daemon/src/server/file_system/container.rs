...
impl Daemon {
    fn handle_fs_event_container_settings(&mut self, event: syre_fs_daemon::Event) -> Vec<Update> {
    ...
    fn handle_container_settings_modified(&mut self, event: syre_fs_daemon::Event) -> Vec<Update> {
        let [path] = &event.paths()[..] else {
            panic!("invalid paths");
        };
...
impl Daemon {
    fn handle_fs_event_container_assets(&mut self, event: syre_fs_daemon::Event) -> Vec<Update> {
    ...
    fn handle_container_assets_modified(&mut self, event: syre_fs_daemon::Event) -> Vec<Update> {
        let [path] = &event.paths()[..] else {
            panic!("invalid paths");
        };
...
impl Daemon {
    fn handle_fs_event_container_flags(&mut self, event: syre_fs_daemon::Event) -> Vec<Update> {
    ...
    fn handle_container_flags_modified(&mut self, event: syre_fs_daemon::Event) -> Vec<Update> {
        let [path] = &event.paths()[..] else {
            panic!("invalid paths");
        };
